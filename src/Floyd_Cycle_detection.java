...
public class Floyd_Cycle_detection {
    ...
    public int  detectCycle(ArrayList<Integer> a) {
        //List<Integer> turtoise1 = new ArrayList<>(L);
        //turtoise1.set(1,55);
       /* Integer t=0, h=0;
        Iterator<Integer> tortoise = L.iterator();
        Iterator<Integer> hare = L.iterator();
        t=L.get(t);
        h=L.get(L.get(h));
        int i=1;
        while(t!=h)
